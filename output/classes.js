...
function (_Usuario) {
  ...
  function Estudiante(nombre, edad, carrera) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Estudiante).call(this, nombre, edad)); //ejecuta constructor de la superclase
  ...
  _createClass(Estudiante, [{
    key: "mostrarInfo",
    value: function mostrarInfo() {
      return "\n            <b>Nombre:</b> ".concat(this.nombre, " <br/>\n            <b>Edad:</b> ").concat(this.edad, " <br/>\n            <b>Correo:</b> ").concat(this.carrera, " <br/>\n            <hr />\n        ");
    }
  }]);
...
var persona = new Usuario('Alberto', 34, 'correo@correo.com');
document.write(persona.mostrarInfo());
var persona2 = new Estudiante('Alejandro', 36, 'Ingeniero Informatico');
